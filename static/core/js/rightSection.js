...
(function() {
  var CommentsItem, EditPage, RightSectionPage, SingleCommentPage, _ref,
  ...
  SingleCommentPage = (function(_super) {
    ...
    SingleCommentPage.prototype.init = function(commentData, commentsItem) {
      ...
      this.UI['reply'].onclick = function() {
    ...
    SingleCommentPage.prototype.voteUpComment = function() {
      var call,
        _this = this;
      call = this.api.voteupComment(this.commentData.commentid, function(res) {
        if (!res.success) {
    ...
    SingleCommentPage.prototype.voteDownComment = function() {
      var call,
        _this = this;
      call = this.api.votedownComment(this.commentData.commentid, function(res) {
        if (!res.success) {
          return console.error(res.error_msg);
        }
        _this.commentData.praisenum = res.praisenum;
    ...
    SingleCommentPage.prototype.addReply = function() {
      return console.log("add reply");
    };
  ...
  window.RightSection = (function(_super) {
    ...
    RightSection.prototype.addComment = function(commentsItem) {
      ...
      success = function(content) {
        return _this.app.addCommentToMark(content, commentsItem.markData);
      };
      return this.showEditPage("addComment", null, success);
    };
